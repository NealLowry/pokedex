...
std::unordered_map<std::string,std::vector<std::string>> Types::normal(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::grass(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::fire(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::water(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::electric(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::rock(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::poison(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::psychic(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::ice(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::ground(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::flying(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::fighting(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::bug(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::ghost(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::dragon(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::dark(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::steel(){
...
std::unordered_map<std::string,std::vector<std::string>> Types::fairy(){
